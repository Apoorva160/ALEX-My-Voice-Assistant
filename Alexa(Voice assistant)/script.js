...
function handleCommand(command) {
  ...
  if (phrase) {
    ...
    speak("Hey! I'm Alex, your virtual voice assistant, designed to make your digital life easier and more fun.");
  }else if (command.includes("who developed you") || command.includes("who made you")) {
    speak("I am developed by Apoorva Panigrahi!");
...
btn.addEventListener("click", function () {
  speak("Yes Apoorva, how can I help you?");

  setTimeout(() => {
    btn.innerHTML = "Listening...👂";
    btn.classList.add("listening");
    
    avatarVideo.src = "mic-active.gif.mp4"; 
    avatarVideo.play();
  ...
  recognition.onend = () => {
    ...
    avatarVideo.src = "idle-avatar.gif.mp4"; 
    avatarVideo.play();
  };
});
